						...
						.click(
								function() {
									...
									var tr = $("<tr>"
											...
											+ "<input type='text' id='capitalexpendituresUnit8' name='capitalexpendituresUnit8' missingMessage='不能为空' style='width: 80px' class='easyui-validatebox'/></td>"
											+ "<td style='background: #E0ECFF;'>合同金额：</td>"
											+ "<td class='2'><input type='text' id='contractamount8' name='contractamount8'  missingMessage='不能为空' style='width: 80px' class='easyui-validatebox'/></td>"
											+ "<td style='background: #E0ECFF;'>主审审定金额:</td>"
											+ "<td class='3'><input type='text' id='ttvmoney8' name='ttvmoney8'  missingMessage='不能为空' style='width: 80px' class='easyui-validatebox'/></td>"
											+ "<td style='background: #E0ECFF;'>截止审计日:</td>"
											+ "<td class='4'><input type='text' class='datebox11' id='stopAuditTime8' name='stopAuditTime8' class='easyui-validatebox'/></td>"
											+ "<td style='background: #E0ECFF;'>已支付金额：</td>"
											+ "<td class='5'><input type='text' id='amountpaid8' name='amountpaid8'  missingMessage='不能为空' style='width: 80px' class='easyui-validatebox'/>"
									...
									$(this).parent().parent().prev().children("td.1").children().validatebox(
																			{
																				required : true
																			});
									$(this).parent().parent().prev().children("td.2").children().numberbox(
																			{
																				required : true,
																				precision : 2
																			});
									$(this).parent().parent().prev().children("td.3").children().numberbox(
																			{
																				required : true,
																				precision : 2
																			});
									$(this).parent().parent().prev().children("td.4").children().datebox( {
										required : true,
										disabled : false,
										panelWidt : 300,
										panelHeight : 220
									});
									$(this).parent().parent().prev().children("td.5").children().numberbox(
																			{
																				required : true,
																				precision : 2
																			});
