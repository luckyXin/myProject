	...
	$('#detailDiv').tabs({
		onSelect : function(title) {
			if ('月报表信息' == title) {
				...
				$.post($("#coutextPath").val() + "/search/myselfTractProject/getDedailInfo.do", {
...
function initializationOtherManage() {
	...
	var url = $("#coutextPath").val()
			+ '/search/myselfTractProject/find.do?otherManageFind=0&biaoDuanId=' + biaoDuanId;
...
function initdatafile() {
	...
	var biaoDuanId = $("#biaoDuanId").val();
	var url = $("#coutextPath").val()
			+ '/search/myselfTractProject/find.do?cailiaoxunjia=1&biaoDuanId=' + biaoDuanId;
...
function initializationZhengCeChange() {
	...
	var biaoDuanId = $("#biaoDuanId").val();
	var url = $("#coutextPath").val()
			+ '/search/myselfTractProject/find.do?zhengCeChangeFind=0&biaoDuanId='
			+ biaoDuanId;
...
function initializationClaimIndemnityTable() {
	...
	var url = $("#coutextPath").val()
			+ '/search/myselfTractProject/find.do?claimindemnity=0&biaoDuanId='
...
function initializationChangeCodeInfo() {
	...
	var url = $("#coutextPath").val()
			+ '/search/myselfTractProject/find.do?changeCardState=0&biaoDuanId='
...
function initializationReportMonth() {
	...
	var url = $("#coutextPath").val() + '/search/myselfTractProject/find.do?monthReprotState=0&biaoDuanId='+ $("#biaoDuanId").val();
