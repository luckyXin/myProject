...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/areaLeaderAuditEdit.js"></script>
		</script>
		<style type="text/css">
body {
	margin: 10px;
		...
		<form id="form" method="post">
			<div id="mainDiv">
				...
				<div id="p3" class="easyui-panel"
					...
					collapsible="true" title="分管领导工程竣工结算审核" iconCls="icon-tip">
					...
					<table class="form" style="width: 99%; border-style: none;"
						...
						<tbody>
							<c:if test="${areaLeaderAuditBaseInfo == null}">
								<tr>
									<td class="label">
										审批意见：
									</td>
							...
							<c:if test="${areaLeaderAuditBaseInfo != null}">
								<tr>
									...
									<td style="width: 90%;" colspan="3">
										<input type="hidden" id="auditId" name="auditId"
											value="${areaLeaderAuditBaseInfo.id}">
										<textarea rows="5" id="remark" name="remark"
											style="width: 50%;">
											${areaLeaderAuditBaseInfo.remark}
									</textarea>
									</td>
								</tr>
								<tr>
									...
									<td style="width: 90%;" colspan="3">
										<c:if test="${areaLeaderAuditBaseInfo.passState == '1'}">
											<input type="radio" value="1" name="passState"
												class="radioClass" checked="checked">
										不同意 &nbsp;&nbsp;&nbsp;
										<input type="radio" value="2" name="passState"
										...
										<c:if test="${areaLeaderAuditBaseInfo.passState == '2'}">
											<input type="radio" value="1" name="passState"
												class="radioClass">
										不同意 &nbsp;&nbsp;&nbsp;
										<input type="radio" value="2" name="passState"
								...
								<tr>
									...
									<td style="width: 90%;" colspan="3">
										<c:if test="${areaLeaderAuditBaseInfo.isSubmit == '1'}">
											<input type="checkbox" value="1" id="state" name="state"
												checked="checked">
										已确认 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span style="color: red;">确认之后无法修改</span>
