...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractBiaoDuanClaimIndemnityEdit.js"></script>
		<title>标段创建</title>
		<style type="text/css">
body {
	margin: 0px;
	...
	<body>
		...
		<div id="mainDiv">
			...
			<div id="p11" class="easyui-panel"
				...
				collapsible="true" title="索赔信息列表" iconCls="icon-search">
				<div style="margin: 1px;">
						...
						<c:if test="${con=='delete.do'}">
							<a href="javascript:void(0);" onclick="delsuop();return false;"  id="delete" iconCls="icon-remove"
