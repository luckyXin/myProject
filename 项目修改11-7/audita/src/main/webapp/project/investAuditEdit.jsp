...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/investAuditEdit.js"></script>
		</script>
		<style type="text/css">
body {
	margin: 10px;
		...
		<form id="form" method="post">
			<div id="mainDiv">
								...
								<tbody>
								   <tr>
									...
									<tr>
										...
										<c:if test="${legalDepartAuditView.isLegalLeaderAudit == '2'}">
	                                                                                                                     同意							
										</c:if>
										</td>
										<td align="right" class="showLabel">
				...
				<div id="p3" class="easyui-panel"
					style="background: #fafafa; margin-bottom: 5px;"
					collapsible="true" title="投资科室审签信息" iconCls="icon-tip">
					...
					<table class="form" style="width: 99%; border-style: none; margin-bottom: 10px;"
						...
						<tbody>
								...
								<tr>
									...
									<td style="width: 90%;" colspan="3">
									    <c:if test="${investDepartAuditView.isInvestLeaderAudit == '1'}">
