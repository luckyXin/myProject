...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractProjectCreateIndex.js"></script>
		<style type="text/css">
body {
	margin-left: 0px;
	margin-top: 0px;
	...
	<body>
		<div id="mainDiv" style="width: 100%; margin: 5px;">
					...
					<div id="center" style="margin-top: 10px;" align="center">
						<table class="form" cellspacing="0" width="99%">
							<tbody>
								...
								<tr>
								    <td align="right" width="20%">提交状态：</td>
								    <td>
								      <select id="submitState" style="width: 200px;" class="easyui-combobox" >
			...
			<div id="p2" class="easyui-panel" style="background: #fafafa;"
				collapsible="true" title="跟踪项目立项" iconCls="icon-tip">
