...
$(function() {
	$("#proj_info_id").combobox({
		valueField : 'code',
		textField : 'name',
		url : "/audit-admin/ShowInfoAction/projInfo/list",
		editable : false,
		disabled : isTrue,
		onShowPanel : function() {
			$("#proj_info_id").combobox("hidePanel");
			aaa.window("open");
		}
	});
	...
	aaa.find("#adasdasdsadsdsdsads").datagrid(
			{
				url : "/audit-admin/ShowInfoAction/projInfoDataManage/query",
				idField : "code",
				columns : [ [ {
					field : "name",
					title : "项目名称",
				...
				onDblClickRow : function(rowIndex, rowData) {
					$("#proj_info_id").combobox("select", rowData.code);
				...
				onLoadSuccess : function() {
					aaa.find("#adasdasdsadsdsdsads").datagrid("selectRecord",
							$("#proj_info_id").combobox("getValue"));
				}
			});
});