...
pagechange($(".pagination-page-list").val());
...
},message:"Please enter a value between {0} and {1}."},reapet:{validator:function(_001,_002){
	var len=$.trim(_001);
	var a_AAA = $("#"+_002).val();
	return a_AAA==len;
},message:"两次输入不一致"},ID_card:{validator:function(_001){
	var patrn=/^\d{14}\d{3}?\w$/; 
	if (!patrn.exec(_001)) return false;
	return true;
},message:"身份证格式错误"},remote:{validator:function(_337,_338){
var data={};
data[_338[1]]=_337;
