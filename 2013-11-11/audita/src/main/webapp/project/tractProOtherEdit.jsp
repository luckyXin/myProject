...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractProOtherEdit.js"></script>
		<title>标段创建</title>
		<style type="text/css">
body {
	margin: 0px;
...
.cancel a {
	...
	<body>
		...
		<div id="mainDiv">
				...
				style="background: #fafafa; height: 400px; margin-bottom: 5px;"
				collapsible="true" title="其它管理列表" iconCls="icon-search">
