...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractProjectMonthReportBiaoDuanEdit.js"></script>
		<title>月报录入</title>
		<style type="text/css">
body {
	margin: 0px;
		...
		<form id="form" method="post">
			<div id="mainDiv">
				...
				<div id="p12" class="easyui-panel"
					...
					collapsible="true" title="月报文件" iconCls="icon-search">
					<a href="javascript:void(0);" id="save" class="easyui-linkbutton"
						iconCls="icon-save">上传</a>
