...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractProjectDataTransferIndex.js"></script>
		<style type="text/css">
body {
	margin-left: 0px;
	margin-top: 0px;
	...
	<body>
		<div id="mainDiv" style="width: 100%; margin: 5px;">
			...
			<div id="p2" class="easyui-panel" style="background: #fafafa;"
				collapsible="true" title="标段信息" iconCls="icon-tip">
					...
					<c:forEach items="${mapFunction}" var="con">
						...
						<c:if test="${con=='add.do'}">
							<a href="javascript:void(0);" id="add" iconCls="icon-add"
								class="easyui-linkbutton">资料移交</a>
