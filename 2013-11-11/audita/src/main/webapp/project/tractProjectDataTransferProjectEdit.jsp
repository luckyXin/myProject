...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractProjectDataTransferEdit.js"></script>
		<title>跟踪审计项目立项-资料移交</title>
		<style type="text/css">
body {
	margin: 0px;
	padding: 0px;
	...
	<body>
		<form id="form" method="post">
			...
			<div id="p3" class="easyui-panel"
				...
				<div style="margin: 1px;">
						<a href="javascript:void(0);" id="addBiaoDuan" class="easyui-linkbutton" iconCls="icon-edit">资料移交</a>
					    <a href="javascript:void(0);" id="update" iconCls="icon-add" class="easyui-linkbutton">编辑</a>
				</div>
