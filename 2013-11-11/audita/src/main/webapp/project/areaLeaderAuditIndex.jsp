...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/areaLeaderAuditIndex.js"></script>
		<style type="text/css">
body {
	margin-left: 0px;
	margin-top: 0px;
	...
	<body>
		<div id="mainDiv" style="width: 100%; margin: 5px;">
			<div id="subDiv" style="margin-bottom: 1px;">
								...
								<tbody>
									...
									<tr>
										<td align="center" colspan="2">
										      法制科滞留项目:
											<input type="hidden" id="legalState" value="0">
											<input type="checkbox" id="legalButton">
										</td>
										<td align="center" colspan="2">
