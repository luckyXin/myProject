...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/staff/staffProOwnerIndex.js"></script>
		<style type="text/css">
body {
	margin-left: 0px;
	margin-top: 0px;
	...
	<body>
		<div id="mainDiv" style="width: 99%; margin: 1px;">
			...
			<div id="p2" class="easyui-panel" style="background: #fafafa;"
				collapsible="true" title="项目业主" iconCls="icon-tip">
					...
					<c:forEach items="${conmap}" var="con">
						...
						<c:if test="${con=='update.do'}">
							<a href="javascript:void(0);" id="update" iconCls="icon-edit"
								class="easyui-linkbutton" onclick="update()">编辑</a>
						</c:if>
