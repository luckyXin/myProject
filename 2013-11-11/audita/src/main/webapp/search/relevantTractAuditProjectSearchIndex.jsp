...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/search/RelevantTractAuditProjectSearchIndex.js"></script>
		<style type="text/css">
body {
	margin-left: 0px;
	margin-top: 0px;
							...
							<table class="form" cellspacing="0" width="99%">
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" id="constructUtil" name="constructUtil"
												style="width: 200px;">
										</td>
										<td align="right" width="20%">
											中介机构：
										...
										<td>
											<input type="hidden" id="intermediaryId"
												name="intermediaryId">
									...
									<tr>
										...
										<td>
											<input type="text" class="easyui-datebox"
												...
												name="projectTransferStartTime" id="projectTransferStartTime">
											~
											<input type="text" class="easyui-datebox"
												style="width: 100px;" readonly="readonly"
												name="projectTransferEndTime" id="projectTransferEndTime">
										</td>
									</tr>
									<tr>
