...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/search/noProcessProjectSearch.js"></script>
		<style type="text/css">
body {
	margin-left: 0px;
	margin-top: 0px;
		...
		<div id="mainDiv" style="width: 100%; margin: 5px;">
			<div id="subDiv" style="margin-bottom: 5px;">
									   ...
									   <td>
										...
										<td>
											<input type="text" class="easyui-datebox"
												style="width: 100px;" id="auditStartTime"
												name="auditStartTime">
											~
											<input type="text" class="easyui-datebox"
												style="width: 100px;" id="auditEndTime" name="auditEndTime">
										</td>
									</tr>
									<tr>
				...
				<div id="p2" class="easyui-panel" style="background: #fafafa;"
					collapsible="true" title="未处理项目列表" iconCls="icon-tip">
