...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/search/OneTractAuditProjectSearchDetailInfo.js"></script>
		<style type="text/css">
body {
	margin: 10px;
	padding: 0px;
							...
							<table class="form"
								...
								<tbody>
									...
									<tr>
										...
										<td id="exceedControllerPrice">
										</td>
										<td class="showLabel">
											低出控价总金额（投标价-控价）万元 ：
										</td>
										<td id="underControllerPrice">
										</td>
									</tr>
								</tbody>
							</table>
