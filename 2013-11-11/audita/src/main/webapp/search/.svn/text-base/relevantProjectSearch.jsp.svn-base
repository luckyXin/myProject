...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/search/relevantProjectSearch.js"></script>
		<style type="text/css">
body {
	margin-left: 0px;
	margin-top: 0px;
		...
		<div id="mainDiv" style="width: 100%; margin: 5px;">
			<div id="subDiv" style="margin-bottom: 5px;">
				<div id="p1" class="easyui-panel"
					style="background: #fafafa; height: 170px; margin-bottom: 5px;"
									...
									<tr>
										...
										<td>
											<input type="text" class="easyui-datebox"
												style="width: 200px;" id="buildYear" name="buildYear">
										</td>
									</tr>
									<tr>
										<td align="right" width="20%">
				...
				<div id="p2" class="easyui-panel" style="background: #fafafa;"
					collapsible="true" title="相关项目信息" iconCls="icon-tip">
