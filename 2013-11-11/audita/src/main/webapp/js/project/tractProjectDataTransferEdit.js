		...
		function() {
			$("#addBiaoDuan").click(function (){
				...
				top.openModule($("#frameId").val(),
						'标段-资料移交','/project/tractProjectDataTransfer/input.do',
						null, 'add', row.id);
			});
...
function initializationBiaoDuan() {
	...
	var url = $("#coutextPath").val() + '/project/tractProjectDataTransfer/find.do?biaoDuanFind=0&projectId='+$("#id").val();
