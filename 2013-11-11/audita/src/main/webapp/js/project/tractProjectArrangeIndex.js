$(document).ready(function() {
					...
					$("#add").click(function() {
						...
						top.openModule($("#frameId").val(),
							'跟踪项目立项-安排','/project/tractProjectArrange/input.do',
							null, 'add', row.id);
					});
					...
					$("#update").click(function() {
										...
										top.openModule($("#frameId").val(),
														'跟踪项目立项-安排编辑',
														'/project/tractProjectArrange/input.do',
														null, 'update', row.id);
									});
					$("#delete").click(function() {
						...
						del("/project/tractProjectArrange/delete.do", 'grid');
					});
	                initialization();
				});
...
function initialization() {
	...
	var url = $("#coutextPath").val() + "/project/tractProjectArrange/find.do?arrangeState="+$("#arrangeState").combobox("getValue");
	$('#grid').treegrid({
		url : url,
