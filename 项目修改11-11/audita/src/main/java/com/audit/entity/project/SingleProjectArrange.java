 ...
 * @author DengXin
 */
public class SingleProjectArrange extends Common {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 2216255357117409972L;
	...
	/**
	 * 法制科审批状态 0 ：未审批 1：通过 2：未通过
	 */
	private String legalSectionChiefAuditState;

	/**
	 * 法制科分管审批状态 0 ：未审批 1：通过 2：未通过
	 */
	private String legalAreaLeaderAuditState;

	/**
	 * 分管领导审批状态 0 ：未审批 1：通过 2：未通过
	 */
	...
	/**
	 * @param dataTransferTime the dataTransferTime to set
	 */
	...
	/**
	 * @return the legalSectionChiefAuditState
	 */
	public String getLegalSectionChiefAuditState() {
		return legalSectionChiefAuditState;
	}

	/**
	 * @param legalSectionChiefAuditState the legalSectionChiefAuditState to set
	 */
	public void setLegalSectionChiefAuditState(String legalSectionChiefAuditState) {
		this.legalSectionChiefAuditState = legalSectionChiefAuditState;
	}

	/**
	 * @return the legalAreaLeaderAuditState
	 */
	public String getLegalAreaLeaderAuditState() {
		return legalAreaLeaderAuditState;
	}

	/**
	 * @param legalAreaLeaderAuditState the legalAreaLeaderAuditState to set
	 */
	public void setLegalAreaLeaderAuditState(String legalAreaLeaderAuditState) {
		this.legalAreaLeaderAuditState = legalAreaLeaderAuditState;
	}
