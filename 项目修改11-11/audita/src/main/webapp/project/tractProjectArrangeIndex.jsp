...
<html>
	<head>
		<title>跟踪审计项目安排</title>
		<jsp:include page="../common/include.jsp"></jsp:include>
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/commonFunction.js"></script>
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractProjectArrangeIndex.js"></script>
		<style type="text/css">
body {
	margin-left: 0px;
	margin-top: 0px;
	...
	<body>
		<div id="mainDiv" style="width: 100%; margin: 5px;">
					...
					<div id="center" style="margin-top: 10px;" align="center">
						<table class="form" cellspacing="0" width="99%">
							<tbody>
								...
								<tr>
								    <td align="right" width="20%">安排状态：</td>
								    <td>
								      <select id="arrangeState" style="width: 200px;" class="easyui-combobox" >
			...
			<div id="p2" class="easyui-panel" style="background: #fafafa;"
				collapsible="true" title="安排信息" iconCls="icon-tip">
					...
					<c:forEach items="${mapFunction}" var="con">
						...
						<c:if test="${con=='add.do'}">
							<a href="javascript:void(0);" id="add" iconCls="icon-add"
								class="easyui-linkbutton">安排</a>
						</c:if>
						<c:if test="${con=='update.do'}">
							<a href="javascript:void(0);" id="update" iconCls="icon-add"
