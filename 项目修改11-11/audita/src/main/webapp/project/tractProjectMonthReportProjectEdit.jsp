...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractProjectMonthReportEdit.js"></script>
		<title>跟踪审计项目立项-月报录入</title>
		<style type="text/css">
body {
	margin: 0px;
	padding: 0px;
	...
	<body>
		<form id="form" method="post">
			...
			<div id="p3" class="easyui-panel"
				...
				<div style="margin: 1px;">
						<a href="javascript:void(0);" id="addBiaoDuan" class="easyui-linkbutton" iconCls="icon-edit">月报录入</a>
				</div>
