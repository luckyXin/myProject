...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/project/tractProjectArrangeEdit.js"></script>
	...
	<body>
		...
		<div style="width: 98%;" id="mainDiv">
			...
			<div id="p3" class="easyui-panel"
				...
				<div style="margin: 1px;">
						<a href="javascript:void(0);" id="addBiaoDuan" class="easyui-linkbutton" iconCls="icon-edit">安排</a>
				</div>
