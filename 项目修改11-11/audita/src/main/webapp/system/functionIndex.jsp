...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/js/system/functionIndex.js"></script>
		<title>菜单管理</title>
		<style type="text/css">
body {
	margin-left: 0px;
	...
	<div style="width: 100%;margin: 5px;">
		<div id="button-bar" style="margin: 5px;">
				<c:forEach items="${map}" var="function">
					...
					<c:if test="${function == 'destroy.do'}">
						<a href="javascript:void(0);" iconCls="icon-cancel" class="easyui-linkbutton" id="destroy" >注销</a>
					</c:if>
				</c:forEach>
			</div>
